...
- Metadata reading with filename fallback
- Embedded cover art display when available
- Real play/pause and previous/next playback for local files
- Progress and lyric synchronization from the real audio position
